...
def run_episode(env, policy, scaler, animate=False):
    ...
    # ==== !!!!!!!!!!!!!!! =========
    policy.stochastic_policy = False # Change back later
    # ==== !!!!!!!!!!!!!!! =========
...
def evaluate(env_name, num_episodes):
    env, obs_dim, act_dim = init_gym(env_name)
    ...
    scaler = Scaler(obs_dim)
    # scaler.vars = [2.53235618e-02, 3.68267468e-03,1.76878948e-03,1.46061686e-01,
    # 3.38706655e-01,4.28742652e-01,1.55248345e+00,7.42267790e-01,
    # 6.29188908e-01,5.49941123e+00,2.79394966e+01,1.46166708e-01]
    # scaler.means = [1.25981651,0.00822646, -0.02264081,-0.53807856,0.16797635,
    # 1.43694166,-0.1332834, 0.02766244, -0.01382823, -0.51812599,0.0070711,0.01711499]

    # scaler.first_pass = False
