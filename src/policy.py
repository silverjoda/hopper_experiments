...
class Policy(object):
    ...
    def __init__(self, obs_dim, act_dim, kl_targ, stochastic_policy=True):
        """
        Args:
    ...
    def save_weights(self):
        with self.g.as_default():
            ...
            saver.save(self.sess, "/home/shagas/Data/SW/RL_ALGOS/trpo/src/models/policy/trained_model")

    def restore_weights(self):
        with self.g.as_default():
            saver = tf.train.Saver()
            saver.restore(self.sess, tf.train.latest_checkpoint("/home/shagas/Data/SW/RL_ALGOS/trpo/src/models/policy/"))
